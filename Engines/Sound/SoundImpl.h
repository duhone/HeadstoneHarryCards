...
namespace CR
{
	namespace Sound
	{
		...
		private:
			...
			std::tr1::unordered_map<CR::Utility::Guid,std::tr1::shared_ptr<Buffer>,CR::Utility::GuidHash > m_buffers;
			ALCcontext* m_context;
			ALCdevice* m_device;
			std::tr1::shared_ptr<Music> m_music;
			unsigned int m_sourceIds[32];
			std::vector<unsigned int> m_availableSources;
			std::tr1::unordered_map<CR::Utility::Guid,std::tr1::shared_ptr<SoundPrototype>,CR::Utility::GuidHash> m_soundPrototypes;
